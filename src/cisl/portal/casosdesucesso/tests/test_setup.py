...
from cisl.portal.casosdesucesso.interfaces import IBrowserLayer
from cisl.portal.casosdesucesso.testing import FUNCTIONAL_TESTING
...
class TestInstall(BaseTestCase):
    ...
    def test_static_resource_grokker(self):
        ...
        browser.open('%s/++resource++cisl.portal.casosdesucesso' % portal_url)
